...
def eta(socl, soch, N, tabla: np.ndarray, model: NearestNeighbors):
    ...
    if 0 <= soch <= 1 and 0 <= soch <= 1:
        if soch > socl:
            ...
            '''
            '''
            tabla = np.array([[0.5, 1, 1.00000000],
                              [0.625, 0.75, 1.00000266],
                              [0.375, 0.75, 1.00001860],
                              [0.75, 0.5, 0.99999203],
                              [0.5, 0.5, 1.00001521],
                              [0.25, 0.5, 1.00002874],
                              [0.875, 0.25, 1.00002146],
                              [0.625, 0.25, 1.00000881],
                              [0.5, 0.25, 1.00000620],
                              [0.375, 0.25, 1.00003347],
                              [0.125, 0.25, 1.00004184]])
            '''
            tabla = np.array([[0.5, 1, 0.999930],
                              [0.625, 0.75, 0.999963],
                              [0.375, 0.75, 0.999972],
                              [0.75, 0.5, 0.999981],
                              [0.5, 0.5, 0.999987],
